...
export default class GroupContextModal extends Component {
    ...
    preGo() {
        this.props.functions.prevGo(this.props.itemData.id);
        this.props.functions.onHide();
    }

    afterGo() {
        this.props.functions.afterGo(this.props.itemData.id);
        this.props.functions.onHide();
    }
        ...
        return (
            <ContextModal bgClick={onHide} data={posData}>
                <ul>
                    ...
                    <li>
                        <div onClick={this.preGo.bind(this)}>
                            <i className='fa fa-trash'></i>
                            <span>{`前移`}</span>
                        </div>
                    </li>
                    <li>
                        <div onClick={this.afterGo.bind(this)}>
                            <i className='fa fa-trash'></i>
                            <span>{`后移`}</span>
                        </div>
                    </li>
