	...
	render() {
		...
		return (
			<div>
				...
				<TextField id="with-placeholder" label="请输入作品名称" placeholder="标题" margin="normal" defaultValue={defaultTitle} inputRef={input => (this.titleRef = input)} />

				<br />
				<TextField id="with-placeholder" label="请输入作品简介" placeholder="内容" margin="normal" multiline rows={2} rowsMax={4} fullWidth defaultValue={defaultSummary} inputRef={input => (this.summaryRef = input)} />
				<TextField id="with-placeholder" label="更多内容" placeholder="填写网站地址 展示更多内容" margin="normal" multiline rows={2} rowsMax={4} fullWidth defaultValue={defaultMoreInfo} inputRef={input => (this.moreInfo = input)} style={{ marginTop: 50 }} />
