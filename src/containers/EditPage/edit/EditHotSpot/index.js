    ...
    renderEditByType() {
        ...
        let hotSpotTypeActions = {
            type1: () => {
                ...
                return <EditSelectScene action={action} ref={(ref) => (this.editEle = ref)} selectId={null} sceneList={sceneList} allSceneList={allSceneList} folderId={folderId} sceneSelected={sceneSelected} vrId={vrId}></EditSelectScene>;
            },
            type2: () => {
