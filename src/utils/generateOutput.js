...
export function GenerateOutput(vrItem, sceneList, hotpotList, groupList, allSceneList, cb) {
	...
	fs.writeFileSync(path.resolve(vrPath, "./index.html"), template({ title: vrItem.title, foreImagePC: foreImagePCPath, foreImageMobile, showBack: vrItem.showBack, backToWelcome: vrItem.backToWelcome }));
	fs.copyFileSync(path.resolve(electron_app_krpano_path, "../backBtn.png"), path.resolve(vrPath, "./backBtn.png"));
